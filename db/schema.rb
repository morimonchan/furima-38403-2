...
ActiveRecord::Schema.define(version: 2022_10_03_074604) do
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "sent_day_id", null: false
  ...
  create_table "sents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_history_id"], name: "index_sents_on_purchase_history_id"
  end
  ...
  add_foreign_key "sents", "purchase_histories"
end
