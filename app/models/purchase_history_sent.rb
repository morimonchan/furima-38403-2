class PurchaseHistorySent
  ...
  with_options presence: true do
    validates :code, format: { with: /\A[0-9]{3}-[0-9]{4}\z/, message: 'ハイフンを含めてください' }
    validates :city
  ...
  def save
    ...
    Sent.create(code: code, place_id: place_id, city: city, street_address: street_address, building: building,
